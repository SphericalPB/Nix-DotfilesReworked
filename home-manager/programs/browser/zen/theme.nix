{config, ...}: {
  ...
  programs.zen-browser = {
    ...
    profiles.Funky-Rodent = {
      userChrome = ''
        :root {
          --zen-colors-primary: #${config.lib.stylix.colors.base00} !important;
          --zen-primary-color: #${config.lib.stylix.colors.base07} !important;
          --zen-colors-secondary: #${config.lib.stylix.colors.base03} !important;
          --zen-colors-tertiary: #${config.lib.stylix.colors.base01} !important;
          --zen-colors-border: #${config.lib.stylix.colors.base07} !important;
          --toolbarbutton-icon-fill: #${config.lib.stylix.colors.base07} !important;
        ...
        .content-shortcuts {
          background-color: #${config.lib.stylix.colors.base00} !important;
          border-color: #${config.lib.stylix.colors.base07} !important;
        }
        ...
        .identity-color-red {
          --identity-tab-color: #${config.lib.stylix.colors.base07} !important;
          --identity-icon-color: #${config.lib.stylix.colors.base07} !important;
        }
      ...
      userContent = ''
        ...
        @-moz-document url-prefix("about:") {
          :root {
            ...
            --color-accent-primary: #${config.lib.stylix.colors.base07} !important;
            --color-accent-primary-hover: #${config.lib.stylix.colors.base07} !important;
            --color-accent-primary-active: #${config.lib.stylix.colors.base07} !important;
            background-color: #${config.lib.stylix.colors.base00} !important;
        ...
        @-moz-document url("about:newtab"), url("about:home") {
          ...
          :root {
            --newtab-background-color: #${config.lib.stylix.colors.base00} !important;
            --newtab-background-color-secondary: #${config.lib.stylix.colors.base03} !important;
            --newtab-element-hover-color: #${config.lib.stylix.colors.base03} !important;
            --newtab-text-primary-color: #${config.lib.stylix.colors.base05} !important;
            --newtab-wordmark-color: #${config.lib.stylix.colors.base05} !important;
            --newtab-primary-action-background: #${config.lib.stylix.colors.base07} !important;
          }
        ...
        @-moz-document url-prefix("about:preferences") {
          :root {
            ...
            --link-color: #${config.lib.stylix.colors.base07} !important;
            --link-color-hover: #${config.lib.stylix.colors.base07} !important;
            --zen-colors-primary: #${config.lib.stylix.colors.base03} !important;
            --in-content-box-background: #${config.lib.stylix.colors.base03} !important;
            --zen-primary-color: #${config.lib.stylix.colors.base07} !important;
          }
        ...
        @-moz-document url-prefix("about:addons") {
          :root {
            --zen-dark-color-mix-base: #${config.lib.stylix.colors.base01} !important;
        ...
        @-moz-document url-prefix("about:protections") {
          :root {
            ...
            --in-content-primary-button-background-hover: #${config.lib.stylix.colors.base03} !important;
            --in-content-primary-button-text-color-hover: #${config.lib.stylix.colors.base05} !important;
            --in-content-primary-button-background: #${config.lib.stylix.colors.base03} !important;
